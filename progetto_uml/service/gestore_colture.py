...
class GestoreColture:
    ...
    #sotto metodo per il cabio di un parametro di una coltura specifica
...
#metodo dove proprietario prende i dati dal softweare e li mette nella serra per mod automatica
...
#solo i dati della pianta selezionata , ricordarsi che bisong afare in modo che mostra
#il gestore serra che passi qui è quello istanziato ad inizio programma
#ricordatelo perchè se metti un altro nome va in crash il programma
