...
# definizione della classe Serra che rappresenta una serra automatizzata associata a una coltura e a un proprietario
class Serra:
    ...
    # gestisce automaticamente gli attuatori
    ...
    # restituisce la temperatura corrente della serra
    @property
    def get_temperatura_serra(self) -> float:
        return self.temperatura_serra
    # restituisce l'umidità corrente della serra
    @property
    def get_umidita_serra(self) -> float:
        return self.umidita_serra
    # restituisce i dati della coltura associata
    @property
