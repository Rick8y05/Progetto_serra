...
class MenuOperatore(QWidget):
    def __init__(self, gestore_serra, gestore_colture, gestore_tempo, proiettore_pagine):
        ...
        self.setWindowTitle("Pannello di Controllo Operatore")
    ...
    def finestra_principale(self):
        ...
        layout_principale.setContentsMargins(50, 60, 50, 60)
        ...
        # titolo con benvenuto
        self.testo_benvenuto = QLabel(f"Benvenuto {self.nome_operatore}")
        self.testo_benvenuto.setStyleSheet("font-size: 32px; font-weight: 700; color: #FFFFFF; letter-spacing: -0.5px;")
        self.testo_benvenuto.setAlignment(Qt.AlignmentFlag.AlignCenter)

        # sottotitolo
        sottotitolo = QLabel("Pannello Operatore — Monitoraggio e Gestione Colture")
        ...
        layout_principale.addWidget(self.testo_benvenuto)
        ...
        # pulsante visualizza dati serra operatore
        btn_visualizza_dati_serra = QPushButton("Visualizza Dati Serra")
        btn_visualizza_dati_serra.clicked.connect(lambda: self.proiettore_pagine.setCurrentIndex(9))

        # pulsante aggiorna parametri colture operatore
        btn_configura_parametri_coltura = QPushButton("Configura Parametri Coltura")
        btn_configura_parametri_coltura.clicked.connect(lambda: self.proiettore_pagine.setCurrentIndex(10))

        # pulsante per disconnessione
        btn_logout = QPushButton("Disconnetti")
        btn_logout.clicked.connect(QApplication.quit)
        ...
        btn_logout.setStyleSheet(stile_mac_premium)
        ...
        layout_bottoni.addWidget(btn_logout, alignment=Qt.AlignmentFlag.AlignCenter)
